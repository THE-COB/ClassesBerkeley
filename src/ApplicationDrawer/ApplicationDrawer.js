      ...
      <Collapse in={open}>
        <Drawer.Overflow>
          <Drawer.ToC>
            ...
            <button id="moneyButton" onClick={(e) => {
              e.preventDefault();
              window.open("https://docs.google.com/document/d/1ZT_LdIdgnP3uAJUOcZ961IxLnwLybDp0ZvHyJsBwcIY/edit?usp=sharing", '_blank');
            }} className='moneyLink'>It has come to my attention that things cost money</button>
